...
public class ExpMod extends EBin {

   public ExpMod(int fila, int columna, Exp opnd1, Exp opnd2) {
      super(fila, columna, KindExp.MOD, opnd1, opnd2);
   }

   public String toString() {
      return "  |ExpMod| " + opnd1.toString() + " % " + opnd2.toString() + ')';
   }
