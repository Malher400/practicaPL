...
public class ExpMayIg extends EBin {

   public ExpMayIg(int fila, int columna, Exp opnd1, Exp opnd2) {
      super(fila, columna, KindExp.MAYORIGUAL, opnd1, opnd2);
   }

   public String toString() {
      return "  |ExpMayIg| " + opnd1.toString() + " >= " + opnd2.toString() + ')';
   }
