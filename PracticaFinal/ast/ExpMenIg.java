...
public class ExpMenIg extends EBin {

   public ExpMenIg(int fila, int columna, Exp opnd1, Exp opnd2) {
      super(fila, columna, KindExp.MENORIGUAL, opnd1, opnd2);
   }

   public String toString() {
      return "  |ExpMenIg| " + opnd1.toString() + " <= " + opnd2.toString() + ')';
   }
